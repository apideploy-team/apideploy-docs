...
* [操作指南](user-guide/index.md)
    ...
    * [Python SDK接入](user-guide/apideploy-python-sdk-access.md)
    * [API接口对接](user-guide/apideploy-api.md)
    * [文档导入接入](user-guide/apideploy-import-api.md)
    
* [私有化部署](deploy/private-deployment.md)

    * [私有化部署介绍](deploy/apideploy-private-deployment-introduces.md)
